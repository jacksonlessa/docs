...
necessária para a request. Muitas vezes isto é em forma de HTML, XML ou JSON,
mas streaming de arquivos e criação de PDF's que os usuários podem baixar
também são responsabilidades da Camada View.
